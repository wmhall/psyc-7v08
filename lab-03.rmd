---
title: "Lab 03: Introduction to dplyr"
output:
  github_document:
    toc: true
    toc_depth: 4
...
If you haven't worked through [lab 1](https://github.com/wmhall/psyc-7v08/blob/main/posted/labs/lab-01/lab-01-getting-started.md) and [lab 2](lab-02.md), go ahead and finish those first. 
...
Before we go any further, we should exploit the new pipe operator that `dplyr` imports from the [`magrittr`](https://magrittr.tidyverse.org/articles/magrittr.html) package. This is going to change your data analytical life. You no longer need to enact multi-operation commands by nesting them inside each other, like so many [Russian nesting dolls](https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Floral_matryoshka_set_2_smallest_doll_nested.JPG/1024px-Floral_matryoshka_set_2_smallest_doll_nested.JPG). This new syntax leads to code that is much easier to write and to read.
...
* Get to know [`rowwise()`](https://dplyr.tidyverse.org/articles/rowwise.html), you won't regret it!
...
* `dplyr()` section of your [textbook](https://r4ds.had.co.nz/transform.html)

`%>%` stuff

* An excellent Rstudio conf (2017) [talk](https://rstudio.com/resources/rstudioconf-2017/writing-readable-code-with-pipes/) on Writing Readable Code with Pipes
* [r4ds](https://rstudio.com/resources/rstudioconf-2017/writing-readable-code-with-pipes/) chapter on pipes.