...
Using the approaches I described in the lecture, work to create two useful `csv` files from this dataset. One of the `csvs` should contain the data and the other a codebook.  

When creating the `csv` for the dataset, you'll want to convert some of the columns to factors so that you don't lose important information. 

The second `csv` should be a codebook and might look something like this: 
