...
To make a look-up table, you need to generate a data frame. There are lots of ways to make your very own data frame (`data.frame()`, `tibble()`, `tribble()`, etc). To learn more about `tibble()` and `tribble()`, read the r4ds chapter on [tibbles](https://r4ds.had.co.nz/tibbles.html).
